      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div className="bg-white rounded-lg p-8 text-[#0DA596]">
            ...
            <p className="mb-4">
              If you're facing issues with the app (e.g., broken links, bugs, or
              usability problems), please reach out:
            </p>
          ...
          <div className="bg-white rounded-lg p-8 text-[#0DA596]">
            <h3 className="text-2xl font-bold mb-6">💬 Suggest Improvements</h3>
            <p className="mb-4">
