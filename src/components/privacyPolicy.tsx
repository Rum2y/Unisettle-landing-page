            ...
            <div className="bg-white rounded-lg p-8 text-[#0DA596] space-y-6">
              ...
              <div>
                ...
                <p className="mb-4">
                  ...
                  you voluntarily provide it. The types of data we may collect
                  include:
                </p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                  ...
                  <li>
                    ...
                    Device type, OS version, and app version (for
                    troubleshooting and improvements).
                  </li>
                  <li>
                    <span className="font-medium">Optional User Input:</span> If
                    you contact us through the app (e.g., feedback or support),
                    we may collect your email or message content.
                  </li>
                </ul>
                <p className="font-medium">
                  We do NOT collect: names, addresses, SIN, Alberta ID numbers,
              ...
              <div>
                ...
                <p>
                  Our App may contain links to third-party services (e.g.,
                  Google Maps, government websites). These services have their
